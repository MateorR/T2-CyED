...
public class Move {
  ...
  public static void down(Animal animal) {
    if (animal.getY() % 32 == 0 && animal.getX() % 32 == 0) {
      if (animal instanceof Player && Blocked.blockDown(animal)) {
  ...
  private static void downStep(Animal animal) {
    ...
    validatePosition(animal);
  }

  private static void validatePosition(Animal animal) {
  ...
  public static void up(Animal animal) {
    if (animal.getY() % 32 == 0 && animal.getX() % 32 == 0) {
      if (animal instanceof Player && Blocked.blockUp(animal)) {
  ...
  private static void upStep(Animal animal) {
    if (animal instanceof Player && animal.getY() % 8 == 0) {
      if (animal.getSwap() == 1) {
    ...
    validatePositionBallom(animal);
  }

  private static void validatePositionBallom(Animal animal) {
    if (animal instanceof Ballom && animal.getY() % 8 == 0) {
      if (animal.getSwap() == 1) {
  ...
  public static void left(Animal animal) {
    if (animal.getX() % 32 == 0 && animal.getY() % 32 == 0) {
      if (animal instanceof Player && Blocked.blockLeft(animal)) {
  ...
  private static void leftStep(Animal animal) {
  ...
  public static void right(Animal animal) {
    if (animal.getX() % 32 == 0 && animal.getY() % 32 == 0) {
      if (animal instanceof Player && Blocked.blockRight(animal)) {
  ...
  public static void rightStep(Animal animal) {
    if (animal instanceof Player && animal.getX() % 8 == 0) {
      if (animal.getSwap() == 1) {
